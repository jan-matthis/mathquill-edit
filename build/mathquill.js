...
LatexCmds.boldsymbol = bind(Style, '\\boldsymbol', 'b', 'class="font"');
...
LatexCmds['∑'] = LatexCmds.sum = LatexCmds.summation = LatexCmds.suml= bind(BigSymbol,'\\sum ','&sum;');
...
LatexCmds.limits = bind(BinaryOperator,'\\limits ','');
